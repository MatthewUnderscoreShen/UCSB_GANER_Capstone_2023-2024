...
echo_and_run cd "/home/capstone/UCSB_GANER_Capstone_2023-2024/src/tasks"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/capstone/UCSB_GANER_Capstone_2023-2024/src/tasks/setup.py" \
     \
    build --build-base "/home/capstone/UCSB_GANER_Capstone_2023-2024/build/tasks" \
    install \
    --root="${DESTDIR-/}" \
