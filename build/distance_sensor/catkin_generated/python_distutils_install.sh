...
echo_and_run cd "/home/capstone/UCSB_GANER_Capstone_2023-2024/src/distance_sensor"
...
echo_and_run /usr/bin/env \
    ...
    "/home/capstone/UCSB_GANER_Capstone_2023-2024/src/distance_sensor/setup.py" \
     \
    build --build-base "/home/capstone/UCSB_GANER_Capstone_2023-2024/build/distance_sensor" \
    install \
    --root="${DESTDIR-/}" \
