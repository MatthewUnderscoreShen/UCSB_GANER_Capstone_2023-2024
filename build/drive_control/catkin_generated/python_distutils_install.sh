...
echo_and_run cd "/home/capstone/UCSB_GANER_Capstone_2023-2024/src/drive_control"
...
echo_and_run /usr/bin/env \
    ...
    "/home/capstone/UCSB_GANER_Capstone_2023-2024/src/drive_control/setup.py" \
     \
    build --build-base "/home/capstone/UCSB_GANER_Capstone_2023-2024/build/drive_control" \
    install \
    --root="${DESTDIR-/}" \
