...
echo_and_run cd "/home/capstone/UCSB_GANER_Capstone_2023-2024/src/gpio_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/capstone/UCSB_GANER_Capstone_2023-2024/src/gpio_control/setup.py" \
     \
    build --build-base "/home/capstone/UCSB_GANER_Capstone_2023-2024/build/gpio_control" \
    install \
    --root="${DESTDIR-/}" \
