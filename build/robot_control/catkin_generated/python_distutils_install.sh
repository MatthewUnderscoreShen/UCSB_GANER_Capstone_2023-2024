...
echo_and_run cd "/home/capstone/UCSB_GANER_Capstone_2023-2024/src/robot_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/capstone/UCSB_GANER_Capstone_2023-2024/src/robot_control/setup.py" \
     \
    build --build-base "/home/capstone/UCSB_GANER_Capstone_2023-2024/build/robot_control" \
    install \
    --root="${DESTDIR-/}" \
