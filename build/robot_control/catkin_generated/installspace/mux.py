...
def test_callback(data):
    ...
    # Not sure how to distribute commands yet

    if data.data == "Teleop":
        pub_command.publish(String("teleop_on"))
    elif data.data == "Autonomous":
        pub_command.publish(String("autonomous_on"))
