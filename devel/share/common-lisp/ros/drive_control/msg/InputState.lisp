...
(cl:defmethod cl:initialize-instance :after ((m <InputState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InputState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drive_control-msg:<InputState> is deprecated: use drive_control-msg:InputState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <InputState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drive_control-msg:header-val is deprecated.  Use drive_control-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <InputState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drive_control-msg:state-val is deprecated.  Use drive_control-msg:state instead.")
  (state m))

(cl:ensure-generic-function 'pin-val :lambda-list '(m))
(cl:defmethod pin-val ((m <InputState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drive_control-msg:pin-val is deprecated.  Use drive_control-msg:pin instead.")
  (pin m))
