...
(cl:defmethod cl:initialize-instance :after ((m <OutputState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OutputState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drive_control-msg:<OutputState> is deprecated: use drive_control-msg:OutputState instead.")))
...
(cl:defmethod duration-val ((m <OutputState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drive_control-msg:duration-val is deprecated.  Use drive_control-msg:duration instead.")
  (duration m))
